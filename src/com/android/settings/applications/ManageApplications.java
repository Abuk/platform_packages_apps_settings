...
public class ManageApplications extends InstrumentedFragment
    ...
    public static final int FILTER_APPS_SUBSTRATUM_ICONS = 17;
    ...
    static class ApplicationsAdapter extends BaseAdapter implements Filterable,
        ...
        public void rebuild(boolean eraseold) {
            ...
            if (!mManageApplications.mShowSystem && !mManageApplications.mShowSubstratum && !mManageApplications.mShowSubstratumIcons) {
                ...
                filterObj = new CompoundFilter(filterObj,
                        ApplicationsState.FILTER_SUBSTRATUM);
            } else if (!mManageApplications.mShowSubstratumIcons) {
                filterObj = new CompoundFilter(filterObj,
                        ApplicationsState.FILTER_SUBSTRATUM_ICONS);
            }
